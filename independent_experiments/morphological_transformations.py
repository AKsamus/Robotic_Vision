...
original_and_binary = np.hstack((resized_girl, cv2.cvtColor(binary, cv2.COLOR_GRAY2BGR)))
original_and_dilated = np.hstack((resized_girl, cv2.cvtColor(dilated, cv2.COLOR_GRAY2BGR)))
original_and_eroded = np.hstack((resized_girl, cv2.cvtColor(eroded, cv2.COLOR_GRAY2BGR)))
original_and_opened = np.hstack((resized_girl, cv2.cvtColor(opened, cv2.COLOR_GRAY2BGR)))
original_and_closed = np.hstack((resized_girl, cv2.cvtColor(closed, cv2.COLOR_GRAY2BGR)))
original_and_gradient = np.hstack((resized_girl, cv2.cvtColor(gradient, cv2.COLOR_GRAY2BGR)))
original_and_tophat = np.hstack((resized_girl, cv2.cvtColor(tophat, cv2.COLOR_GRAY2BGR)))
original_and_blackhat = np.hstack((resized_girl, cv2.cvtColor(blackhat, cv2.COLOR_GRAY2BGR)))
#cv2.imshow("Original Image vs Binary Image", original_and_binary)
#cv2.imshow("Original Image vs Dilated Image", original_and_dilated)
#cv2.imshow("Original Image vs Eroded Image", original_and_eroded)
#cv2.imshow("Original Image vs Opened Image", original_and_opened)
#cv2.imshow("Original Image vs Closed Image", original_and_closed)
#cv2.imshow("Original Image vs Gradient Image", original_and_gradient)
#cv2.imshow("Original Image vs Top Hat Image", original_and_tophat)
#cv2.imshow("Original Image vs Black Hat Image", original_and_blackhat)
cv2.imwrite("Results/morphological_transformations/original_vs_binary.png", original_and_binary)
cv2.imwrite("Results/morphological_transformations/original_vs_dilated.png", original_and_dilated)
cv2.imwrite("Results/morphological_transformations/original_vs_eroded.png", original_and_eroded)
cv2.imwrite("Results/morphological_transformations/original_vs_opened.png", original_and_opened)
cv2.imwrite("Results/morphological_transformations/original_vs_closed.png", original_and_closed)
cv2.imwrite("Results/morphological_transformations/original_vs_gradient.png", original_and_gradient)
cv2.imwrite("Results/morphological_transformations/original_vs_tophat.png", original_and_tophat)
cv2.imwrite("Results/morphological_transformations/original_vs_blackhat.png", original_and_blackhat)
